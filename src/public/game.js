class FastFallGame {
    ...
    drawDebugInfo() {
        ...
        y += lineHeight;
        this.ctx.fillText(`Player Y: ${this.player.y.toFixed(1)}`, 20, y);
        y += lineHeight;
        this.ctx.fillText(`Player Z: ${this.player.z.toFixed(1)}`, 20, y);
        y += lineHeight;
        this.ctx.fillText(`Game Speed: ${this.gameSpeed.toFixed(1)}`, 20, y);
        y += lineHeight;
        this.ctx.fillText(`Altitude: ${this.altitude.toFixed(0)}`, 20, y);
        y += lineHeight;
        this.ctx.fillText(`Wind X: ${this.wind.x.toFixed(2)}`, 20, y);
        y += lineHeight;
        this.ctx.fillText(`Wind Strength: ${this.wind.strength.toFixed(1)}`, 20, y);
        y += lineHeight;
